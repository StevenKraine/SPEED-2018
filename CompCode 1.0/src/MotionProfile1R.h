...
#ifndef SRC_MOTIONPROFILE1R_H_
#define SRC_MOTIONPROFILE1R_H_
...
class MotionProfileController1R {
public:
	/**
	...
	MotionProfileController1R(TalonSRX & talon) :
		RightDrive(talon), _notifer(&MotionProfileController1R::PeriodicTask, this) {
		/*
