...
void Robot::RobotInit() {
  ...
  Climb1.ConfigSelectedFeedbackSensor(QuadEncoder,0,10);
  Climb1.SetSensorPhase(true);

  Climb1.SetInverted(true);
  Climb2.SetInverted(true);
  Climb1.ConfigPeakOutputForward(001,10);
  Climb1.ConfigPeakOutputReverse(-.5,10);
  LiftFollower.SetInverted(!Lift.GetInverted());
  LiftFollower.Follow(Lift,FollowerType::FollowerType_PercentOutput);
   Climb1.Config_kP(0,.3,10);
  Climb1.Config_kI(0,0,10);
  Climb1.Config_kD(0,10);
...
if (m_autoSelected == kAutoNameCustom) {
 ...
 JoystickDriveOne(0);
  AutonLimelight(0);
     nt::NetworkTableInstance::GetDefault().GetTable("limelight")->PutNumber("pipeline",nt::NetworkTableInstance::GetDefault().GetTable("limelight")->PutNumber("pipeline",0));
...
void Robot::TeleopPeriodic() {
  loopidee++;
  //Climb1.Set(ControlMode::PercentOutput,.10);
...
void Robot::ClimbControl(){
  frc::SmartDashboard::PutNumber("climbOveride", ClimbOveride);
  ...
  if(ClimbOveride==1 and Manipulatortwo.GetRawButtonPressed(4)==1){
    Climb1.Set(ControlMode::Position,53000);//25000
  }
  if(ClimbOveride==1 and Manipulatortwo.GetRawButtonPressed(1)==1){
    Climb1.Set(ControlMode::Position,0);
  }
   if(ClimbOveride==1 and Manipulatortwo.GetRawButtonPressed(5)==1){
    Climb1.Set(ControlMode::Position,27000);
  }
  if(ClimbOveride==1 and Manipulatortwo.GetRawButton(3)==1){
    ClimbFoot.Set(ControlMode::PercentOutput,1);
  }else if(ClimbOveride==1 and Manipulatortwo.GetRawButton(10)==1){
    ClimbFoot.Set(ControlMode::PercentOutput,-.50);
  }else{
    ClimbFoot.Set(ControlMode::PercentOutput,0);
  }
...
void Robot::SmartDashboard(){
 ...
 frc::SmartDashboard::PutNumber("Climb",Climb1.GetSelectedSensorPosition(0));
  }
...
void Robot::RollerClawControl(){
  if(ClimbOveride == 0){
    if(Manipulatortwo.GetRawButton(5)==1 and Lift.GetSelectedSensorPosition()<7000){
  ...
  RollerClaw.Set(ControlMode::PercentOutput,.25);
  }else{
...
void Robot::IntakeControl(){
  ...
  if( Manipulatortwo.GetRawButton(5)==1){
    ...
    if(Manipulatortwo.GetRawButton(3)==1){
  ...
  else if(Manipulatortwo.GetRawButton(5)==0 and Manipulatortwo.GetRawButton(11)==0 and Lift.GetSelectedSensorPosition(0)>9000 and Lift.GetClosedLoopTarget()>7999  )
  {
    IntakeArm.Set(ControlMode::Position,000);
...
void Robot::LiftControl(){
 ...
 // Robot::ElevatorSet(10000);
  ...
  if(Manipulatortwo.GetRawButtonPressed(2)==1){
    ElevatorHeight=ElevatorHeight +2000;
  }
...
void Robot::AutonLimelight(bool Go){
  ...
  frc::SmartDashboard::PutNumber("RawX0",RawX0);
   ...
   // }
   if (Go==1){
     nt::NetworkTableInstance::GetDefault().GetTable("limelight")->GetNumber("<camMode>",0.0);
     nt::NetworkTableInstance::GetDefault().GetTable("limelight")->GetNumber("<ledMode>",3);
   nt::NetworkTableInstance::GetDefault().GetTable("limelight")->PutNumber("ledMode",3);
   nt::NetworkTableInstance::GetDefault().GetTable("limelight")->PutNumber("camMode",0);
  if(target==1){
 ...
 LeftDrive.Set(ControlMode::Velocity,0);//Driver.GetY(frc::XboxController::kRightHand)-TurnSpeed);
      ...
      nt::NetworkTableInstance::GetDefault().GetTable("limelight")->GetNumber("<ledMode>",1);
      nt::NetworkTableInstance::GetDefault().GetTable("limelight")->GetNumber("<camMode>",1);
      nt::NetworkTableInstance::GetDefault().GetTable("limelight")->PutNumber("ledMode",1);
   nt::NetworkTableInstance::GetDefault().GetTable("limelight")->PutNumber("camMode",1);
      // LeftDrive.Set(ControlMode::Velocity,0);//Driver.GetY(frc::XboxController::kRightHand)-TurnSpeed);
