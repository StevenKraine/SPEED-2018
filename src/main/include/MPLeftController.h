#ifndef MPLeftController__h_
#define MPLeftController__h_
/**
...
public:
	...
	MPLeft(TalonSRX & talon) :
			LeftDrive(talon), _notifer(&MPLeft::PeriodicTask, this) {
		/*
	...
	void startFilling(int ProfileSlt) {
...
break;
case 1:
startFilling(kMotionProfile1,kMotionProfileSz1);
break;
case 2:
startFilling(CircleL,CircleSzL);
break;
case 3:
startFilling(LivLysProfL,LivLysProfSzL);
break;
case 4:
startFilling(textbubbleL,textbubbleszL);
break;
case 5:
startFilling(squigglesL,squigglesszL);
break;
case 6:
startFilling(tenfootpathL,tenfootpathszL);
break;
case 7:
startFilling(LeftTurn,LeftTurnSz);
break;
		}
