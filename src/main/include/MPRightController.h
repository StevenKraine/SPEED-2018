#ifndef MPRightController__h_
#define MPRightController__h_
/**
...
int ProfileSlotR;
	...
	MPRight(TalonSRX & talon) :
			RightDrive(talon), _notifer(&MPRight::PeriodicTask, this) {
		/*
	...
	void startFilling() {
		...
		switch(ProfileSlotR){
			...
			break;
			case 1:
			startFilling(kMotionProfileR1, kMotionProfileSzR1);
			break;
			case 2:
			startFilling(CircleR,CircleSZR);
			break;
			case 3:
			startFilling(LivLysProfR,LivLysProfSzR);
			break;
			case 4:
			startFilling(textbubbleR,textbubbleszR);
			break;
			case 5:
			startFilling(squigglesR,squigglesszR);
			break;
			case 6:
			startFilling(tenfootpathR,tenfootpathszR);
			break;
			case 7:
			startFilling(RightTurn,RightTurnSz);
			break;
		}
