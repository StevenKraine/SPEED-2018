...
#ifndef CONTROLLERLLRR_H_
#define CONTROLLERLLRR_H_

#include "Instrumentation.h"
#include "ProfileLLRR.h"
#include "WPILib.h"
#include "Constants.h"
...
public:
	...
	ControllerLLRR(TalonSRX & talon) :
			LeftDrive(talon), _notifer(&ControllerLLRR::PeriodicTask, this) {
		/*
	...
	void startFilling() {
		...
		startFilling(kMotionProfileLLRR, kMotionProfileLLRRSz);
	}
