...
#ifndef SRC_CONTROLLERRLRL_H_
#define SRC_CONTROLLERRLRL_H_

#include "Instrumentation.h"
#include "ProfileRLRL.h"
#include "WPILib.h"
#include "Constants.h"
...
public:
	...
	ControllerRLRL(TalonSRX & talon) :
			LeftDrive(talon), _notifer(&ControllerRLRL::PeriodicTask, this) {
		/*
	...
	void startFilling() {
		...
		startFilling(kMotionProfileRLRL, kMotionProfileRLRLSz);
	}
