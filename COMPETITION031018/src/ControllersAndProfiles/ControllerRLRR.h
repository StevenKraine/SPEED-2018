...
#ifndef SRC_CONTROLLERRLRR_H_
#define SRC_CONTROLLERRLRR_H_

#include "Instrumentation.h"
#include "ProfileRLRR.h"
#include "WPILib.h"
#include "Constants.h"
...
public:
	...
	ControllerRLRR(TalonSRX & talon) :
			LeftDrive(talon), _notifer(&ControllerRLRR::PeriodicTask, this) {
		/*
	...
	void startFilling() {
		...
		startFilling(kMotionProfileRLRR, kMotionProfileRLRRSz);
	}
