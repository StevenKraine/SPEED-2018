...
#ifndef SRC_CONTROLLERRRLR_H_
#define SRC_CONTROLLERRRLR_H_
...
#include "ProfileRRLR.h"

using namespace ctre::phoenix::motion;

class ControllerRRLR {
public:
	/**
	...
	ControllerRRLR(TalonSRX & talon) :
		RightDrive(talon), _notifer(&ControllerRRLR::PeriodicTask, this) {
		/*
	...
	void startFilling() {
			...
			startFilling(kMotionProfileRRLR, kMotionProfileRRLRSz);
		}
