...
#ifndef SRC_CONTROLLERRLLL_H_
#define SRC_CONTROLLERRLLL_H_

#include "Instrumentation.h"
#include "ProfileRLLL.h"
#include "WPILib.h"
#include "Constants.h"
...
public:
	...
	ControllerRLLL(TalonSRX & talon) :
			LeftDrive(talon), _notifer(&ControllerRLLL::PeriodicTask, this) {
		/*
	...
	void startFilling() {
		...
		startFilling(kMotionProfileRLLL, kMotionProfileRLLLSz);
	}
