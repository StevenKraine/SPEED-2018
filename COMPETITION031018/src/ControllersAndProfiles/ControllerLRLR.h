...
#ifndef SRC_CONTROLLERLRLR_H_
#define SRC_CONTROLLERLRLR_H_
...
#include "ProfileLRLR.h"

using namespace ctre::phoenix::motion;

class ControllerLRLR {
public:
	/**
	...
	ControllerLRLR(TalonSRX & talon) :
		RightDrive(talon), _notifer(&ControllerLRLR::PeriodicTask, this) {
		/*
	...
	void startFilling() {
			...
			startFilling(kMotionProfileLRLR, kMotionProfileLRLRSz);
		}
