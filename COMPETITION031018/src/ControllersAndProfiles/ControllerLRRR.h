...
#ifndef SRC_CONTROLLERLRRR_H_
#define SRC_CONTROLLERLRRR_H_
...
#include "ProfileLRRR.h"

using namespace ctre::phoenix::motion;

class ControllerLRRR {
public:
	/**
	...
	ControllerLRRR(TalonSRX & talon) :
		RightDrive(talon), _notifer(&ControllerLRRR::PeriodicTask, this) {
		/*
	...
	void startFilling() {
			...
			startFilling(kMotionProfileLRRR, kMotionProfileLRRRSz);
		}
