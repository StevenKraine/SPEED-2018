...
#ifndef SRC_CONTROLLERLRLL_H_
#define SRC_CONTROLLERLRLL_H_
...
#include "ProfileLRLL.h"

using namespace ctre::phoenix::motion;

class ControllerLRLL {
public:
	/**
	...
	ControllerLRLL(TalonSRX & talon) :
		RightDrive(talon), _notifer(&ControllerLRLL::PeriodicTask, this) {
		/*
	...
	void startFilling() {
			...
			startFilling(kMotionProfileLRLL, kMotionProfileLRLLSz);
		}
