...
#ifndef SRC_CONTROLLERRRRL_H_
#define SRC_CONTROLLERRRRL_H_
...
#include "ProfileRRRL.h"

using namespace ctre::phoenix::motion;

class ControllerRRRL {
public:
	/**
	...
	ControllerRRRL(TalonSRX & talon) :
		RightDrive(talon), _notifer(&ControllerRRRL::PeriodicTask, this) {
		/*
	...
	void startFilling() {
			...
			startFilling(kMotionProfileRRRL, kMotionProfileRRRLSz);
		}
