...
#ifndef SRC_CONTROLLERRRLL_H_
#define SRC_CONTROLLERRRLL_H_
...
#include "ProfileRRLL.h"

using namespace ctre::phoenix::motion;

class ControllerRRLL {
public:
	/**
	...
	ControllerRRLL(TalonSRX & talon) :
		RightDrive(talon), _notifer(&ControllerRRLL::PeriodicTask, this) {
		/*
	...
	void startFilling() {
			...
			startFilling(kMotionProfileRRLL, kMotionProfileRRLLSz);
		}
