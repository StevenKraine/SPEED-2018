...
#ifndef SRC_CONTROLLERRLLR_H_
#define SRC_CONTROLLERRLLR_H_

#include "Instrumentation.h"
#include "ProfileRLLR.h"
#include "WPILib.h"
#include "Constants.h"
...
public:
	...
	ControllerRLLR(TalonSRX & talon) :
			LeftDrive(talon), _notifer(&ControllerRLLR::PeriodicTask, this) {
		/*
	...
	void startFilling() {
		...
		startFilling(kMotionProfileRLLR, kMotionProfileRLLRSz);
	}
