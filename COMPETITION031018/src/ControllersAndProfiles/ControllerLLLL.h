...
#ifndef SRC_CONTROLLERLLLL_H_
#define SRC_CONTROLLERLLLL_H_

#include "Instrumentation.h"
#include "ProfileLLLL.h"
#include "WPILib.h"
#include "Constants.h"
...
public:
	...
	ControllerLLLL(TalonSRX & talon) :
			LeftDrive(talon), _notifer(&ControllerLLLL::PeriodicTask, this) {
		/*
	...
	void startFilling() {
		...
		startFilling(kMotionProfileLLLL, kMotionProfileLLLLSz);
	}
