...
#ifndef SRC_CONTROLLERLRRL_H_
#define SRC_CONTROLLERLRRL_H_
...
#include "ProfileLRRL.h"

using namespace ctre::phoenix::motion;

class ControllerLRRL {
public:
	/**
	...
	ControllerLRRL(TalonSRX & talon) :
		RightDrive(talon), _notifer(&ControllerLRRL::PeriodicTask, this) {
		/*
	...
	void startFilling() {
			...
			startFilling(kMotionProfileLRRL, kMotionProfileLRRLSz);
		}
