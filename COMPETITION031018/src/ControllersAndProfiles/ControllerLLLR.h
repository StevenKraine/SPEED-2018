...
#ifndef SRC_CONTROLLERLLLR_H_
#define SRC_CONTROLLERLLLR_H_

#include "Instrumentation.h"
#include "ProfileLLLR.h"
#include "WPILib.h"
#include "Constants.h"
...
public:
	...
	ControllerLLLR(TalonSRX & talon) :
			LeftDrive(talon), _notifer(&ControllerLLLR::PeriodicTask, this) {
		/*
	...
	void startFilling() {
		...
		startFilling(kMotionProfileLLLR, kMotionProfileLLLRSz);
	}
