...
#ifndef CONTROLLERLLRL_H_
#define CONTROLLERLLRL_H_
#include "Instrumentation.h"
#include "ProfileLLRL.h"
#include "WPILib.h"
#include "Constants.h"
...
public:
	...
	ControllerLLRL(TalonSRX & talon) :
			LeftDrive(talon), _notifer(&ControllerLLRL::PeriodicTask, this) {
		/*
	...
	void startFilling() {
		...
		startFilling(kMotionProfileLLRL, kMotionProfileLLRLSz);
	}
