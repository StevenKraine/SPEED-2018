...
#ifndef SRC_CONTROLLERRRRR_H_
#define SRC_CONTROLLERRRRR_H_
...
#include "ProfileRRRR.h"

using namespace ctre::phoenix::motion;

class ControllerRRRR {
public:
	/**
	...
	ControllerRRRR(TalonSRX & talon) :
		RightDrive(talon), _notifer(&ControllerRRRR::PeriodicTask, this) {
		/*
	...
	void startFilling() {
			...
			startFilling(kMotionProfileRRRR, kMotionProfileRRRRSz);
		}
