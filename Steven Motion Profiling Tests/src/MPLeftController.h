...
#ifndef SRC_MPLEFTCONTROLLER_H_
#define SRC_MPLEFTCONTROLLER_H_
...
public:
	...
	MPLeftController(TalonSRX & talon) :
			LeftDrive(talon), _notifer(&MPLeftController::PeriodicTask, this) {
		/*
	...
	void startFilling() {
		...
		startFilling(kLeftProfile, kLeftProfileSz);
