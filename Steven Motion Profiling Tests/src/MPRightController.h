...
#ifndef SRC_MPRIGHTCONTROLLER_H_
#define SRC_MPRIGHTCONTROLLER_H_
...
public:
	...
	MPRightController(TalonSRX & talon) :
			RightDrive(talon), _notifer(&MPRightController::PeriodicTask, this) {
		/*
	...
	void startFilling() {
		...
		startFilling(kRightProfile, kRightProfileSz);
	}
...
#endif /* SRC_MPRIGHTCONTROLLER_H_ */
